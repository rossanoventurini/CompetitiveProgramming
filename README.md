...
| 30/11/2020 | Dynamic Programming:  0/1 Knapsack, fractional knapsack, and Subset sum. | [Rossano's notes\*](notes/DynamicProgramming.md) (or [pdf](notes/DynamicProgramming.pdf)). 0/1 knapsack problem: [tutorial](https://www.youtube.com/watch?v=8LusJS5-AGo) | [Subset sum](https://practice.geeksforgeeks.org/problems/subset-sum-problem/0), [Minimum number of jumps](https://practice.geeksforgeeks.org/problems/minimum-number-of-jumps/0)|
| 02/13/2020 | Dynamic Programming: Longest increasing subsequence, Longest bitonic subsequence, Coin change, and Largest independent set on trees| [Rossano's notes\*](notes/DynamicProgramming.md) (or [pdf](notes/DynamicProgramming.pdf)) | [Longest increasing subsequence](https://practice.geeksforgeeks.org/problems/longest-increasing-subsequence/0) and [Longest bitonic subsequence](https://practice.geeksforgeeks.org/problems/longest-bitonic-subsequence/0) |

...
|14/10/2019 | Prefix sum: Binary Indexed Tree (aka BIT or Fenwick tree) | [Rossano's notes\*](notes/lecture5-6.pdf). BIT: [description](https://en.wikipedia.org/wiki/Fenwick_tree), [tutorial](https://www.topcoder.com/community/data-science/data-science-tutorials/binary-indexed-trees/#add), [video](https://www.youtube.com/watch?v=CWDQJGaN1gY), [visualgo](https://visualgo.net/fenwicktree), and [code](/code/fenwick_tree.hpp).| [Update the array](http://www.spoj.com/problems/UPDATEIT/) ([solution](Solutions.md#LittleGirl))
|15/10/2019 | Coding: applications of BIT. Range update with BIT. Static RMQ with sparse table. | [Rossano's notes\*](notes/lecture5-6.pdf). Sparse table: [tutorial](http://www.geeksforgeeks.org/range-minimum-query-for-static-array/), [paper](http://www.ics.uci.edu/~eppstein/261/BenFar-LCA-00.pdf), and [code](https://github.com/spaghetti-source/algorithm/blob/master/data_structure/sparse_table.cc). [Range updates on BIT](http://petr-mitrichev.blogspot.com/2013/05/fenwick-tree-range-updates.html). Sparse table for static RMQ. [Static RMQ in 2n + o(n) bits and constant time](https://epubs.siam.org/doi/10.1137/090779759)(optional). [RMQ with BIT](http://ioinformatics.org/oi/pdf/v9_2015_39_44.pdf) (optional) | [Nested segments](http://codeforces.com/problemset/problem/652/D?locale=en) ([solution](Solutions.md#NestedSegments)) and [Pashmak and Parmida's problem](http://codeforces.com/problemset/problem/459/D?locale=en) ([solution](Solutions.md#PashmakParmida)) |

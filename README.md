...
| 18/10/2017 | Coding: applications of BIT.  [Range updates on BIT](http://petr-mitrichev.blogspot.com/2013/05/fenwick-tree-range-updates.html). Sparse table for static RMQ.| [Rossano's notes\*](notes/lecture5-6.pdf). Sparse table: [tutorial](http://www.geeksforgeeks.org/range-minimum-query-for-static-array/) and [code](https://github.com/spaghetti-source/algorithm/blob/master/data_structure/sparse_table.cc). | [Nested segments](http://codeforces.com/problemset/problem/652/D?locale=en) ([solution](Solutions.md#NestedSegments)) and [Pashmak and Parmida's problem](http://codeforces.com/problemset/problem/459/D?locale=en) ([solution](Solutions.md#PashmakParmida)) |
| 20/10/2017 | Mo's algorithm on sequences and trees   |  Mo's Algorithm: [Sequences](https://blog.anudeep2011.com/mos-algorithm/) and [Trees](http://codeforces.com/blog/entry/43230) |  [Powerful array](http://codeforces.com/contest/86/problem/D) and [Tree and queries](http://codeforces.com/blog/entry/10084) |

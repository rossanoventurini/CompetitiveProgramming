...
| | Sparse array for static RMQ. Segment Tree: RMQ, Prefix Sums, ... | Spare array: [tutorial](http://www.geeksforgeeks.org/range-minimum-query-for-static-array/) and [code](https://github.com/spaghetti-source/algorithm/blob/master/data_structure/sparse_table.cc). Segment Tree: [description](https://en.wikipedia.org/wiki/Segment_tree), [tutorial](http://www.geeksforgeeks.org/segment-tree-set-1-sum-of-given-range), [video](https://www.youtube.com/watch?v=ZBHKZF5w4YU&list=PLrmLmBdmIlpv_jNDXtJGYTPNQ2L1gdHxu&index=22), [visualgo](https://visualgo.net/en/segmenttree?slide=1), and [code](/code/segment_tree.hpp). Lazy propagation: [tutorial](http://www.geeksforgeeks.org/lazy-propagation-in-segment-tree/) and [video](https://www.youtube.com/watch?v=xuoQdt5pHj0&list=PLrmLmBdmIlpv_jNDXtJGYTPNQ2L1gdHxu&index=23). [RMQ with BIT](http://ioinformatics.org/oi/pdf/v9_2015_39_44.pdf) (optional)| Solve the previous problem sets by replacing Fenwick tree with segment tree. [Circular RMQ](http://codeforces.com/problemset/problem/52/C)|

...
| 27/10/2017 | [Rossano's notes\*](notes/lecture9.pdf). Graph algorithms: BFS, DFS, and Topological Sort | [CCLR] Chapter 22 | [X total shapes](http://practice.geeksforgeeks.org/problems/x-total-shapes/0), [IsBipartite](http://practice.geeksforgeeks.org/problems/bipartite-graph/1), and [Fox and Names](http://codeforces.com/problemset/problem/510/C?locale=en) |
...
| ------------- | ------------- | ------------- | ------------- |
|   | Graph algorithms: Minimum Shortest Path and Strongly Connected Components| Strongly Connected Components: [notes](http://www.personal.kent.edu/~rmuhamma/Algorithms/MyAlgorithms/GraphAlgor/strongComponent.htm). [CCLR] Chapters 22 and 23  | [Learning Languages](http://codeforces.com/problemset/problem/277/A?locale=en) and [Checkposts](http://codeforces.com/problemset/problem/427/C?locale=en) |

...
| 18/11/2020 | Dynamic Programming: Fibonacci numbers, Rod cutting, and Longest common subsequence | [Rossano's notes\*](notes/DynamicProgramming.md) (or [pdf](notes/DynamicProgramming.pdf)). [CCLR] Chapter 15. |[Longest common subsequence](https://practice.geeksforgeeks.org/problems/longest-common-subsequence/0), and [0-1 knapsack](https://www.spoj.com/problems/KNAPSACK/) |
| 23/11/2020 | Dynamic Programming:  Minimum cost path, 0/1 Knapsack, Subset sum, and Coin change | [Rossano's notes\*](notes/DynamicProgramming.md) (or [pdf](notes/DynamicProgramming.pdf)). 0/1 knapsack problem: [tutorial](https://www.youtube.com/watch?v=8LusJS5-AGo) | [Subset sum](https://practice.geeksforgeeks.org/problems/subset-sum-problem/0), [Minimum number of jumps](https://practice.geeksforgeeks.org/problems/minimum-number-of-jumps/0), and [Edit distance](https://practice.geeksforgeeks.org/problems/edit-distance/0) |
## Last year lectures
| Date | Lecture | References | Problems |
| ------------- | ------------- | ------------- | ------------- |
